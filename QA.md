...
<!-- #### **Как следует использовать СЗИ от НСД**

Необходимо использовать сертифицированные СЗИ от НСД, соответствующие классу защиты системы. Класс защиты зависит от количества пользователей АС, режима её эксплуатации, и от обрабатываемой там информации. Все программно-аппаратные средства должны быть сертифицированы в соответствии с классами, определяемыми РД (руководящим докупентом) Гостехкомиссии России.
